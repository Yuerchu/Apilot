...
function TooltipArrow({
  ...
  return (
    <MotionTooltipArrow
      ...
      style={{ rotate: deg }}
      {...(withTransition
        ? { layoutId: `tooltip-arrow-${globalId}`, transition }
        : {})}
      {...props}
    />
  );
            ...
            <FloatingProvider value={{ context, arrowRef }}>
              ...
              >
                <Component
                  ...
                  transition={transition}
                  {...(() => {
                    const { ref: _ref, ...rest } = rendered.data!.contentProps;
                    return rest;
                  })()}
                  {...(rendered.data.contentProps?.ref !== undefined
                    ? { ref: rendered.data.contentProps.ref }
                    : {})}
                  style={{
                    position: 'relative',
